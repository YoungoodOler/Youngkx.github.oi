/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare/worker-configuration.d.ts` (hash: 860d045f755ced817fdd502ff2a67344)
// Runtime types generated with workerd@1.20260804.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	LINKS: KVNamespace;
	ASSETS: Fetcher;
	LINKS_ADMIN_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINKS_ADMIN_TOKEN">> {}
}
